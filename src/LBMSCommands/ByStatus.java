...
/**
 * Sorts a list of books by the status of available copies.
 * Books with no copies availbile are not shown.
 *
...
public class ByStatus implements SortOrder
{
    ...
    /**
     * Implements a Comparator that compares books by availible copies.
