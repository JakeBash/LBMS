...
/**
 * Sorts an array of books by publish date. Newly published books are listed before older books.
 *
...
public class ByPublishDate implements SortOrder
{
    ...
    private static Comparator<Book> BookDateComparator = new Comparator<Book>()
    {
         ...
         * @return A negative, zero, or a positive integer if b1's publish date is alphanumerically less than, equal to,
         * or greater than b2's publish date.
         */
        @Override
